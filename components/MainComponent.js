    ...
    return (
      <View style={[styles.container]}>
        <ImageBackground
          ...
          <View
            style={[styles.textInput, {marginTop: 20, flexDirection: 'row'}]}>
            <DatePicker
            ...
            <Button
              ...
              onPress={() => {
                if (this.state.name == '') {
                  ...
                  Alert.alert('Please enter your DOB');
                } else if (this.state.flatListData[0].destinyNum == '') {
      ...
      <View
        ...
        <View style={styles.oddRow}>
          ...
          <Text style={[styles.flatListItem]}>
            {this.props.item.cardinalNum}
          </Text>
        </View>
        <View style={styles.evenRow}>
          <Text style={[styles.flatListItem]}>Destiny No.</Text>
          <Text style={[styles.flatListItem]}>
            {this.props.item.destinyNum}
          </Text>
        </View>
        <View style={styles.oddRow}>
        ...
        <View style={styles.evenRow}>
          ...
          <Text style={[styles.flatListItem]}>
            {this.props.item.monthNumber}
          </Text>
        </View>
        <View style={styles.oddRow}>
          <Text style={[styles.flatListItem]}>This year Varsh Fal</Text>
          <Text style={[styles.flatListItem]}>
            {this.props.item.thisVarshFal}
          </Text>
        </View>
      </View>
    );
