...
export default class SecondComponent extends Component {
  ...
  doAllCalculations = (params) => {
    ...
    // Alert.alert(
    //   'In doAllCalculations = ' + params.dd + ' ' + params.mm + ' ' + params.yy,
    // );
    dob = dob.replace(/0/g, '');
    this.setState(() => {
      return {
  ...
  getItemValue(val) {
    var dob =
      this.state.dob + '' + this.state.destinyNum + '' + this.state.birthNum;
    var res = '';
  ...
  getTextValue(val) {
    var dob =
      this.state.dob +
      '' +
      this.state.destinyNum +
      '' +
      this.state.birthNum +
      '' +
      this.state.currYearVF +
      '' +
      this.state.currYearMahaDasha;
    var res = '';
    for (var i = 0; i < dob.length; i++) {
      if (dob[i] == val) {
        res += val;
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.gridContainer, {marginTop: 5, flex: 0.5}]}>
          <Grid>
            ...
            <Col>
              <Row style={{backgroundColor: 'red', justifyContent: 'center'}}>
            ...
            <Col>
              ...
              <Row style={{backgroundColor: 'green', justifyContent: 'center'}}>
                <Text style={[styles.gridText, {color: '#fff'}]}>{item8}</Text>
              </Row>
              <Row style={{backgroundColor: 'black', justifyContent: 'center'}}>
        ...
        <View
          style={[
            ...
            {marginLeft: 20, marginRight: 20, marginTop: 10, flex: 0.2},
          ]}>
          <View style={[styles.oddRow]}>
            <Text
              onPress={() => this.showActionSheet(this.props.route.params)}
              style={[styles.flatListItem, {textAlign: 'center'}]}>
              Year
            </Text>
            <Text style={[styles.flatListItem, {textAlign: 'center'}]}>
              M.D.
            </Text>
            <Text style={[styles.flatListItem, {textAlign: 'center'}]}>
              V.F.
        ...
        <View
          style={[
            styles.gridContainer,
            {marginTop: 5, marginBottom: 10, flex: 0.5},
          ]}>
          <Grid>
            <Col>
              <Row
